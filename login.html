...
<body>
  ...
  <script>
    ...
    function validateForm() {
      ...
      while (true) {
        if (uname.trim() === "") {
          unameError.innerHTML = "Please fill in the Username field.";
          isValid = false;
          break; 
        }

        if (psw.trim() === "") {
          pswError.innerHTML = "Please fill in the password field.";
          isValid = false;
          break; 
        }

        if (psw.length < 6) {
          pswError.innerHTML = "Password must be at least 6 characters long.";
          isValid = false;
          break; 
        }
